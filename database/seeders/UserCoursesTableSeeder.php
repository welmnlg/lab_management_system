...
class UserCoursesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('user_courses')->insert([
            ...
            ['user_id' => 5, 'class_id' => 11, 'created_at' => now(), 'updated_at' => now()],
            ['user_id' => 5, 'class_id' => 12, 'created_at' => now(), 'updated_at' => now()],

            // Hermione (user_id=6) ngajar Sistem Basis Data Kom B1,B2 class_id 13,14
            ['user_id' => 6, 'class_id' => 13, 'created_at' => now(), 'updated_at' => now()],
            ['user_id' => 6, 'class_id' => 14, 'created_at' => now(), 'updated_at' => now()],
