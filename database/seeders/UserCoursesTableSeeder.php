...
class UserCoursesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Kim Mingyu (user_id=2) ngajar Praktikum Keamanan Server dan Jaringan (course_id=2)
        // ngajar Kom A1,A2,C1,C2 class_id 5,6,7,8
        ['user_id' => 2, 'class_id' => 5, 'created_at' => now(), 'updated_at' => now()],
        ['user_id' => 2, 'class_id' => 6, 'created_at' => now(), 'updated_at' => now()],
        ['user_id' => 2, 'class_id' => 7, 'created_at' => now(), 'updated_at' => now()],
        ['user_id' => 2, 'class_id' => 8, 'created_at' => now(), 'updated_at' => now()],

        // Wil Ohmsford (user_id=3) ngajar Kursus yang sama Kom B1,B2 class_id 9,10
        ['user_id' => 3, 'class_id' => 9, 'created_at' => now(), 'updated_at' => now()],
        ['user_id' => 3, 'class_id' => 10, 'created_at' => now(), 'updated_at' => now()],

        // Karina (user_id=4) ngajar Praktikum Sistem Basis Data (course_id=3), Kom A1,A2 class_id 11,12
        ['user_id' => 4, 'class_id' => 11, 'created_at' => now(), 'updated_at' => now()],
        ['user_id' => 4, 'class_id' => 12, 'created_at' => now(), 'updated_at' => now()],

        // Hermione (user_id=5) ngajar kursus Sistem Basis Data Kom B1,B2 class_id 13,14
