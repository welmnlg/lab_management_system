...
class RoleUserTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('role_user')->insert([
            ...
            // Kim Mingyu (user_id=2) → Aslab only
            ['user_id' => 2, 'role_id' => 1, 'created_at' => now(), 'updated_at' => now()], // aslab
            
            // Karina (user_id=3) → BPH + Aslab
            ['user_id' => 3, 'role_id' => 1, 'created_at' => now(), 'updated_at' => now()], // aslab
            ['user_id' => 3, 'role_id' => 2, 'created_at' => now(), 'updated_at' => now()], // bph
            
            // Hermione Granger (user_id=4) → BPH + Aslab
            ['user_id' => 4, 'role_id' => 1, 'created_at' => now(), 'updated_at' => now()], // aslab
            ['user_id' => 4, 'role_id' => 2, 'created_at' => now(), 'updated_at' => now()], // bph
        ]);
    }
}