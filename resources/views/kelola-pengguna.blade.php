        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <!-- Button Hapus -->
                    <button id="hapusButton" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-900 to-red-700 text-white rounded-md hover:from-blue-800 hover:to-red-600 transition-all duration-200 shadow-md hover:shadow-lg">
                        <i class="bi bi-trash mr-2"></i>
                        Hapus
                    </button>
                    <!-- Button Tambah Pengguna -->
                    <a href="{{ route('tambah-pengguna') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-900 to-red-700 text-white rounded-md hover:from-blue-800 hover:to-red-600 transition-all duration-200 shadow-md hover:shadow-lg">
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    <th class="px-4 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"></th>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kata Sandi ↓</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Aulia Halimatusyaddiah</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">221402170</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">aulishail?8@gmail.com</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">bablabla</td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Aslab</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Praktikum Kecerdasan Buatan</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">KOM A</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="delete-single-btn inline-flex items-center justify-center w-8 h-8 bg-gradient-to-r from-blue-900 to-red-700 text-white rounded-md hover:from-blue-800 hover:to-red-600 transition-all duration-200 shadow-md hover:shadow-lg" title="Hapus" data-user-id="1" data-user-name="Aulia Halimatusyaddiah">
                ...
                <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">David Hartono</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">221402123</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">davidddz@@gmail.com</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">bablabla</td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Aslab</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Praktikum Desain Interaksi</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">KOM A</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="delete-single-btn inline-flex items-center justify-center w-8 h-8 bg-gradient-to-r from-blue-900 to-red-700 text-white rounded-md hover:from-blue-800 hover:to-red-600 transition-all duration-200 shadow-md hover:shadow-lg" title="Hapus" data-user-id="2" data-user-name="David Hartono">
                                <i class="bi bi-trash"></i>
                            </button>
                        </div>
                    </td>
                ...
                <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Indah Azzahra</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">221402050</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">indashh29@gmail.com</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">bablabla</td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">Admin</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Praktikum Pemrograman Web</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">KOM B</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="delete-single-btn inline-flex items-center justify-center w-8 h-8 bg-gradient-to-r from-blue-900 to-red-700 text-white rounded-md hover:from-blue-800 hover:to-red-600 transition-all duration-200 shadow-md hover:shadow-lg" title="Hapus" data-user-id="3" data-user-name="Indah Azzahra">
                                <i class="bi bi-trash"></i>
                            </button>
                        </div>
                    </td>
                ...
                <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Nurul Aini</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">221402047</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">nurullf28@gmail.com</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">bablabla</td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Aslab</span>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="delete-single-btn inline-flex items-center justify-center w-8 h-8 bg-gradient-to-r from-blue-900 to-red-700 text-white rounded-md hover:from-blue-800 hover:to-red-600 transition-all duration-200 shadow-md hover:shadow-lg" title="Hapus" data-user-id="4" data-user-name="Nurul Aini">
                                <i class="bi bi-trash"></i>
                            </button>
                        </div>
                    </td>
                ...
                <div class="bg-white rounded-lg shadow-lg max-w-md w-full mx-4">
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex justify-center space-x-3">
                            <button id="cancelMultipleDeleteButton" class="inline-flex items-center px-6 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 transition-all duration-200 shadow-md hover:shadow-lg font-medium">
                                Batal
                            </button>
                            <button id="confirmMultipleDeleteButton" class="inline-flex items-center px-6 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-all duration-200 shadow-md hover:shadow-lg font-medium">
                                <i class="bi bi-trash mr-2"></i>
                                Ya, Hapus
                            </button>
                        </div>
            ...
            modal.innerHTML = `
                <div class="bg-white rounded-lg shadow-lg max-w-md w-full mx-4">
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex justify-center space-x-3">
                            <button id="cancelSingleDeleteButton" class="inline-flex items-center px-6 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 transition-all duration-200 shadow-md hover:shadow-lg font-medium">
                                Batal
                            </button>
                            <button id="confirmSingleDeleteButton" class="inline-flex items-center px-6 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-all duration-200 shadow-md hover:shadow-lg font-medium">
                                <i class="bi bi-trash mr-2"></i>
                                Ya, Hapus
                            </button>
                        </div>
